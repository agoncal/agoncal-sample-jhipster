...
import { JacHealthCheckComponent } from 'app/admin/health/health.component';
import { JacHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('JacHealthCheckComponent', () => {
        let comp: JacHealthCheckComponent;
        let fixture: ComponentFixture<JacHealthCheckComponent>;
        let service: JacHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JacksonviewsTestModule],
                declarations: [JacHealthCheckComponent]
            })
                .overrideTemplate(JacHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(JacHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(JacHealthService);
        });
