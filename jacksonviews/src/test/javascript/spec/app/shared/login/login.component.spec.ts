...
import { JacLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: JacLoginModalComponent;
        let fixture: ComponentFixture<JacLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [JacLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(JacLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(JacLoginModalComponent);
