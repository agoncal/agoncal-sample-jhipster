package org.jackson.views.config.timezone;

import org.jackson.views.JacksonviewsApp;
import org.jackson.views.repository.timezone.DateTimeWrapper;
import org.jackson.views.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM jac_date_time_wrapper where id=%d", fieldName, id);
    }
