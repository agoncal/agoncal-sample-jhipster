...
import { AudMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { AudMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('AudMetricsMonitoringModalComponent', () => {
        let comp: AudMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<AudMetricsMonitoringModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [AudMetricsMonitoringModalComponent]
                })
                    .overrideTemplate(AudMetricsMonitoringModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(AudMetricsMonitoringModalComponent);
