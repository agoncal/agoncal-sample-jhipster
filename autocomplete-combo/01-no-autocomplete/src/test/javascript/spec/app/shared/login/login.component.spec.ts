...
import { NoaLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: NoaLoginModalComponent;
        let fixture: ComponentFixture<NoaLoginModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [NoaLoginModalComponent],
                    providers: [
                        {
                    ...
                    .overrideTemplate(NoaLoginModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(NoaLoginModalComponent);
