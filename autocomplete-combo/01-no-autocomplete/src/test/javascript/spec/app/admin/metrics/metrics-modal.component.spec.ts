...
import { NoaMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { NoaMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('NoaMetricsMonitoringModalComponent', () => {
        let comp: NoaMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<NoaMetricsMonitoringModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [NoaMetricsMonitoringModalComponent]
                })
                    .overrideTemplate(NoaMetricsMonitoringModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(NoaMetricsMonitoringModalComponent);
