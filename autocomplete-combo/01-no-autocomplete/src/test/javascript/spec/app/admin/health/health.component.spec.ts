...
import { NoaHealthCheckComponent } from 'app/admin/health/health.component';
import { NoaHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('NoaHealthCheckComponent', () => {
        let comp: NoaHealthCheckComponent;
        let fixture: ComponentFixture<NoaHealthCheckComponent>;
        let service: NoaHealthService;

        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    imports: [NoautocompleteTestModule],
                    declarations: [NoaHealthCheckComponent]
                })
                    .overrideTemplate(NoaHealthCheckComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(NoaHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(NoaHealthService);
        });
