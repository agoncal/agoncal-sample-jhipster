...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: AudLoginModalComponent;
        let fixture: ComponentFixture<AudLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AudLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(AudLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AudLoginModalComponent);
