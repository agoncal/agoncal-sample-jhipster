...
import { AudHealthCheckComponent } from 'app/admin/health/health.component';
import { AudHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('AudHealthCheckComponent', () => {
        let comp: AudHealthCheckComponent;
        let fixture: ComponentFixture<AudHealthCheckComponent>;
        let service: AudHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AutocompletedtoTestModule],
                declarations: [AudHealthCheckComponent]
            })
                .overrideTemplate(AudHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AudHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(AudHealthService);
        });
