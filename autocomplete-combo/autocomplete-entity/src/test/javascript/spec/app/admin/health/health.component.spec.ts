...
import { AueHealthCheckComponent } from 'app/admin/health/health.component';
import { AueHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('AueHealthCheckComponent', () => {
        let comp: AueHealthCheckComponent;
        let fixture: ComponentFixture<AueHealthCheckComponent>;
        let service: AueHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AutocompleteentityTestModule],
                declarations: [AueHealthCheckComponent]
            })
                .overrideTemplate(AueHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AueHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(AueHealthService);
        });
