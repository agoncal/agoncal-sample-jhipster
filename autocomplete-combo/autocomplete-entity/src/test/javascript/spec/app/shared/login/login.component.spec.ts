...
import { AueLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: AueLoginModalComponent;
        let fixture: ComponentFixture<AueLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AueLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(AueLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AueLoginModalComponent);
